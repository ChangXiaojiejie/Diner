...
@Component({
    selector: "contact-slider",
    templateUrl: "./contact.slider.html"
})
export class ContctSliderComponent extends CoreView implements OnInit {
    private _map: any;
    parkRes: string;
    ...
    constructor(
        ...
        super(_contctService, "contact-slider", layout);
    }
